...
def main():
    ...
    image_paths = [
        "./data/PixSolve-test/spe",
        "./data/PixSolve-test/cpe",
        "./data/PixSolve-test/sce",
        "./data/PixSolve-test/hwe"
            ]
    math_files = [
        "./data/PixSolve-test/spe.txt",
        "./data/PixSolve-test/cpe.txt",
        "./data/PixSolve-test/sce.txt",
        "./data/PixSolve-test/hwe.txt"
    ]
